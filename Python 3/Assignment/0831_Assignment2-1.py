        ...
        if ynchoice == 1:
            ...
            if ccchoice == 1:
                ...
                if cash == total:
                    ...
                    print("""결제가 완료되었습니다
                              잔돈 %d원을 반환합니다.""" %(cash - total))
                elif cash < total:
                    print("""금액이 부족합니다.
                              투입 금액인 %d를 반환합니다.""" %cash)
                elif ccchoice == 2:
                    print("카드로 결제가 완료되었습니다. 카드를 챙겨주십시오")
        elif ynchoice == 2:
            print("취소하였습니다. 처음화면으로 돌아갑니다.")
            continue
    elif choice == 9:
        break #잠시 멈추기 용도
    else:
...
투입 금액인 %d를 반환합니다.""" %cash)
    ...
    if choice == 6 and schoice == 1:
        print("%s을(를) 선택하였습니다." %menu_name[6][0])
        order_list.append(menu_name[6][0])
        order_list_price.append(menu_price[6][0])
        print(c_order)
        oxchoice = int(input())
        if oxchoice == 1:
            continue
        ...
        print("%s을(를) 선택하였습니다." %menu_name[6][1])
        order_list.append(menu_name[6][1])
        order_list_price.append(menu_price[6][1])
        print(c_order)
        oxchoice = int(input())
        if oxchoice == 1:
            continue
        ...
        print("%s을(를) 선택하였습니다." %menu_name[6][2])
        order_list.append(menu_name[6][2])
        order_list_price.append(menu_price[6][2])
        print(c_order)
        oxchoice = int(input())
        if oxchoice == 1:
            continue
